...
| Command | Description |
|---|---|
| [`boxctl confext`](confext.md) | Manage configuration extension images in /data/extensions/confext/. |
| [`boxctl config`](config.md) |  |
| [`boxctl diagnose`](diagnose.md) | Collect diagnostics and write a tarball to /tmp (or <dir>). |
| [`boxctl firewall`](firewall.md) | Manage the nftables firewall. |
| [`boxctl logs`](logs.md) |  |
| [`boxctl net`](net.md) |  |
| [`boxctl power`](power.md) | Manage runtime power profile (cpufreq governor + USB autosuspend). |
| [`boxctl reboot`](reboot.md) | Reboot the device, optionally into a specific RAUC slot. |
| [`boxctl rollback`](rollback.md) | Roll back to the previously installed RAUC slot. |
| [`boxctl screen`](screen.md) | Manage HDMI display configuration. |
| [`boxctl service`](service.md) |  |
| [`boxctl status`](status.md) | Show system health: RAUC slot info, AppArmor, dm-verity, failed units, disk and memory usage. |
| [`boxctl sysext`](sysext.md) | Manage system extension images in /data/extensions/sysext/. |
| [`boxctl update`](update.md) | Apply a RAUC bundle. |

---

## [`boxctl confext`](confext.md)
